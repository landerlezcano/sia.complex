...
class evento extends CI_Controller {
	...
	function index() {
		...
		$this->template->build ( 'website/bo/evento/index' );
	}
	...
	function alta() {
		...
		$this->template->set_partial ( 'header', 'website/bo/header' );
		$this->template->set_partial ( 'footer', 'website/bo/footer' );
		$this->template->build ( 'website/bo/evento/alta' );
	}
	function editar() {
		if (! $this->tank_auth->is_logged_in ()) { // logged in
			redirect ( '/auth' );
		...
		$this->template->build ( 'website/bo/evento/editar' );
	}
	function listar() {
		if (! $this->tank_auth->is_logged_in ()) { // logged in
			redirect ( '/auth' );
		...
		$cursos = $this->modelo_evento->listar ();
		$sedes = $this->modelo_sede->consultar_ACT();
		...
		$this->template->set_partial ( 'header', 'website/bo/header' );
		$this->template->set_partial ( 'footer', 'website/bo/footer' );
		$this->template->build ( 'website/bo/evento/listar' );
	}
	function crear() {
		$curso = array (
				'nombre' => $_POST ['nombre'],
