...
class formularios extends CI_Controller {
    ...
    function index() {
        ...
        $this->template->build('website/bo/formularios/index');
    }
    ...
    function alta() {
        ...
        $this->template->set_partial('header', 'website/bo/header');
        $this->template->set_partial('footer', 'website/bo/footer');
        $this->template->build('website/bo/formularios/alta');
    }
    ...
    function listar() {
        ...
        $this->template->set_partial('header', 'website/bo/header');
        $this->template->set_partial('footer', 'website/bo/footer');
        $this->template->build('website/bo/formularios/listar');
    }
    ...
    function empresa_multinivel() {
        ...
        echo $empresa ? "Se ha actualizado los datos de la Empresa Multinivel" : "No se ha podido actualizar los datos de la Empresa Multinivel";
    }

    function entorno_empresa() {
        $empresa = $this->model_admin->entorno_empresa();
        echo $empresa ? "Se ha actualizado los datos de configuración" : "No se ha podido actualizar los datos de configuración";
    }
