	...
	<body class="animated fadeInDown">
		...
		<br />
			<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
				<img id="compania" src="/logo.jpg" alt="">
			</div>
			<div class="hidden-xs col-sm-6 col-md-6 col-lg-6">
				<h1>Sistema Integrado de Administración CUAM &reg;</h1>
			</div>
		</header>
		...
		<style type="text/css" media="screen">
			...
			#compania{height: 125%; margin: -10px auto;}
			#header h1{margin-top: -5px;font-weight: bold !important;}
			header h2{text-align: center; color: rgb(2, 152, 65) ;font-weight: bold !important;font-size: 2em;}
			#login-form{
			...
			#enviar:hover{							
						border-bottom: medium solid #7b9f41;
			}			
