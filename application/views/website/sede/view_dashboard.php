							...
							<div class="row">
								...
								<div class="col-sm-12">
									...
									<div class="row">
										...
										<div class="col-sm-3 profile-pic demo-icon-font">
											<a href="/sede/perfil/foto"><img class="<?php if($actividad) echo "online";?>"
												src="<?=$user?>" width="100%" alt="demo user"></a>
												...
												<li>
													<p class="text-muted">
														<i class="fa fa-phone"></i>&nbsp;&nbsp;(<span
															class="txt-color-darken"><?=$telefono?></span>)
													</p>
												</li>
												<li>
													<p class="text-muted">
