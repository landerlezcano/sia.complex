    ...
    <article class="col-sm-12" style="z-index: 1000;">
        ...
        <div class="navbar navbar-default" style="border-color: rgb(255, 255, 255);">
            ...
            <div class="navbar-header">
                ...
                <img style="width: 5rem; height: auto; padding: 1rem;" src="/logo.jpg" alt="CUAM">
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="/sede/perfil/">
                            <i style="font-size: 2rem;" class="fa fa-user "></i> Perfil </a>
                    </li>
                    <li class="">
                        <a href="/sede/evento/">
                            <i style="font-size: 2rem;" class="fa fa-graduation-cap "></i> Eventos </a>
                    </li>
                    <!-- <li class="">
                        <a href="/bo/reportes">
