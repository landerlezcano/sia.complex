                            ...
                            <table  id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-hide="phone, tablet">Oferta</th>
                                        <th data-hide="phone, tablet">Facultad</th>
                                        <th>Acciones</th>
...
<script type="text/javascript">
                                                                                                    ...
                                                                                                    {
                                                                                                        var msg = "¿Desea desactivar el Curso?";
                                                                                                        var titulo;
                                                                                                        if (estatus == "ACT") {
                                                                                                            msg = "¿Desea activar el Curso?";
                                                                                                            titulo = "Activarcedi";
                                                                                                        }
                                                                                                    ...
                                                                                                    function eliminar(id) {
                                                                                                        ...
                                                                                                        $.ajax({
                                                                                                            ...
                                                                                                            data: {message: '¿ Esta seguro que desea Eliminar el Curso ?'},
                                                                                                        })
                                                                                                                .done(function (msg)
                                                                                                                {
                                                                                                                    bootbox.dialog({
