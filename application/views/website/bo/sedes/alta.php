				...
				-->
					...
					<div>
						...
						<div class="widget-body no-padding">
							...
							<form id="nueva" class="smart-form" method="POST"
								action="/bo/sedes/crear" enctype="multipart/form-data" role='form'>
								<fieldset>
									...
									<div style="width: 25rem;">
										<label class="select">Pais <select id="pais" required
											name="pais" onChange="Departamentos()">
												<option value="-" >-- Seleciona un pais --</option>
													<?php foreach ($pais as $key){ ?>
														<option value="<?=$key->Code?>" <?=($key->Code == "MEX") ? "selected" : ""?> ><?=$key->Name?></option>
													<?php }?>
												</select>
										</label>
									</div>
									...
									<div style="width: 25rem;">
										<label for="" class="select">Estado/Departamento <select
											id="departamento" name="estado"
											onChange="CiudadesDepartamento()" required>
									...
									<label class="input">Codigo Postal <input style="width: 25rem;"
										type="text" name="codigo_postal" placeholder="Codigo Postal"
										class="form-control" required>
									</label> <label class="input">Dirección <input
										style="width: 25rem;" type="text" name="direccion"
										placeholder="Direccion" class="form-control" required>
									</label> <label class="input">Telefono <input
										style="width: 25rem;" type="text" name="telefono"
