...
--
-- Host: 127.0.0.1    Database: siaCuam
-- ------------------------------------------------------
...
CREATE TABLE `billetera` (
  ...
  KEY `FK_U_ID_idx` (`id_user`),
  CONSTRAINT `FK_U_ID2` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `billetera` VALUES (2,'1','ACT','SI'),(38,NULL,'DES','No');
...
--
-- Table structure for table `cat_curso`
--
...
--
-- Dumping data for table `cat_curso`
--

LOCK TABLES `cat_curso` WRITE;
/*!40000 ALTER TABLE `cat_curso` DISABLE KEYS */;
INSERT INTO `cat_curso` VALUES (1,'apertura','apertura','2017-01-04','2017-02-17',1,1,5,38,2,100,100,0,'','ACT'),(2,'Apertura','solo coyoacan','2017-01-10','2017-01-19',2,1,5,38,1,100,0,NULL,'','ACT'),(3,'induccion','Sede central','2017-01-17','2017-01-21',1,1,5,38,2,100,120,0,'','ACT');
/*!40000 ALTER TABLE `cat_curso` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cat_img` VALUES (646,'/media/2/user.jpg','user.jpg','user','jpg','ACT'),(683,'/media/38/user.png','user.png','user','png','ACT'),(699,'/media/cursos/1/logo.png','logo.png','logo','png','ACT'),(828,'/media/cursos/2/Captura_de_pantalla_de_2016-11-14_12:26:22.png','Captura_de_pantalla_de_2016-11-14_12:26:22.png','Captura_de_pantalla_de_2016-11-14_12:26:22','png','ACT'),(829,'/media/cursos/2/Captura_de_pantalla_de_2017-01-06_14:47:28.png','Captura_de_pantalla_de_2017-01-06_14:47:28.png','Captura_de_pantalla_de_2017-01-06_14:47:28','png','ACT'),(830,'/media/cursos/2/Captura_de_pantalla_de_2017-01-11_18:07:07.png','Captura_de_pantalla_de_2017-01-11_18:07:07.png','Captura_de_pantalla_de_2017-01-11_18:07:07','png','ACT'),(831,'/media/cursos/2/TradeMark.png','TradeMark.png','TradeMark','png','ACT'),(832,'/media/cursos/2/TradeMark1.png','TradeMark1.png','TradeMark1','png','ACT');
...
CREATE TABLE `cat_perfil_permiso` (
  ...
  `descripcion` varchar(50) NOT NULL,
  `estatus` varchar(3) NOT NULL,
  `dashboard` varchar(55) DEFAULT '/bo',
...
INSERT INTO `cat_perfil_permiso` VALUES (1,'Administrador total','ACT','/bo'),(2,'Administrativo Sede','ACT','/bo'),(3,'Estudiante','ACT','/ov'),(4,'Docente','ACT','/ob');
...
INSERT INTO `cat_tipo_usuario` VALUES (1,'Admin','Administrador<br/>.','DES',1,1),(2,'Director','Director de Sede','ACT',1,2),(3,'Estudiante','Estudiante<br/>.','ACT',5,3),(4,'Comercial','Comercial','DES',1,1),(5,'Logistica','Logistica','DES',1,1),(6,'Profesor','Docente<br/>.','ACT',4,4),(7,'Funcionario','Personal de Sede','ACT',3,2),(8,'Directivo','Directivo<br/>.','ACT',2,2),(9,'Almacen','Almacen','DES',1,1),(10,'VIP','Cliente VIP','DES',1,1);
...
INSERT INTO `categoria` VALUES (1,'Licenciatura',1,'ACT'),(2,'Certificado',1,'ACT'),(3,'Diplomado',1,'ACT'),(4,'Curso Corto o Taller',1,'ACT'),(5,'Naturopatía',2,'ACT');
...
INSERT INTO `categorizacion` VALUES (1,'oferta','Tipo de Oferta','ACT',1),(2,'catedra','Cátedra<br/>.','ACT',2);
...
INSERT INTO `coaplicante` VALUES (27,38,' ',' ',' ');
...
--
-- Table structure for table `cross_curso_img`
--

DROP TABLE IF EXISTS `cross_curso_img`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `cross_curso_img`
--

LOCK TABLES `cross_curso_img` WRITE;
/*!40000 ALTER TABLE `cross_curso_img` DISABLE KEYS */;
/*!40000 ALTER TABLE `cross_curso_img` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cross_dir_user` VALUES (38,'','','','','','MEX');
/*!40000 ALTER TABLE `cross_dir_user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cross_formulario_atributo`
--

DROP TABLE IF EXISTS `cross_formulario_atributo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `cross_formulario_atributo`
--

LOCK TABLES `cross_formulario_atributo` WRITE;
/*!40000 ALTER TABLE `cross_formulario_atributo` DISABLE KEYS */;
/*!40000 ALTER TABLE `cross_formulario_atributo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cross_formulario_rol`
--

DROP TABLE IF EXISTS `cross_formulario_rol`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cross_formulario_rol` (
  ...
  KEY `FK_formulario_idx` (`FK_formulario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cross_formulario_rol`
--

LOCK TABLES `cross_formulario_rol` WRITE;
/*!40000 ALTER TABLE `cross_formulario_rol` DISABLE KEYS */;
INSERT INTO `cross_formulario_rol` VALUES (2,1),(6,2),(7,1),(8,1),(3,2);
/*!40000 ALTER TABLE `cross_formulario_rol` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cross_formularios`
--

DROP TABLE IF EXISTS `cross_formularios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cross_formularios` (
  `formulario` int(11) NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `cross_formularios`
--

LOCK TABLES `cross_formularios` WRITE;
/*!40000 ALTER TABLE `cross_formularios` DISABLE KEYS */;
INSERT INTO `cross_formularios` VALUES (1,3,1),(1,5,3),(1,10,4),(2,3,1),(2,10,3),(2,6,5),(12,3,1),(12,13,2),(12,10,3),(2,4,2),(12,14,4);
/*!40000 ALTER TABLE `cross_formularios` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cross_img_user` VALUES (2,646),(38,683);
...
INSERT INTO `cross_perfil_usuario` VALUES (1,1),(2,2),(38,4);
...
--
-- Table structure for table `cross_sede_usuario`
--

DROP TABLE IF EXISTS `cross_sede_usuario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cross_sede_usuario` (
  `FK_sede` int(11) NOT NULL DEFAULT '1',
  `FK_user` int(11) NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `cross_sede_usuario`
--

LOCK TABLES `cross_sede_usuario` WRITE;
/*!40000 ALTER TABLE `cross_sede_usuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `cross_sede_usuario` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cross_tel_user` VALUES (2,1,'','ACT'),(2,2,'','ACT'),(38,1,'','ACT'),(38,2,'','ACT');
...
INSERT INTO `cross_user_banco` VALUES (1,2,'Your Card','You','Your Bank','COL',NULL,NULL,NULL,NULL,'ACT'),(2,4,'Your Card','You','Your Bank','COL',NULL,NULL,NULL,NULL,'ACT'),(3,3,'Your Card','You','Your Bank','COL',NULL,NULL,NULL,NULL,'ACT'),(4,6,'Your Card','You','Your Bank','COL',NULL,NULL,NULL,NULL,'ACT'),(5,35,'Your Card','You','Your Bank','COL',NULL,NULL,NULL,NULL,'ACT'),(6,36,'Your Card','You','Your Bank','COL',NULL,NULL,NULL,NULL,'ACT'),(7,37,'Your Card','You','Your Bank','COL',NULL,NULL,NULL,NULL,'ACT');
...
INSERT INTO `curso` VALUES (1,'Naturopatía','Prom 1',1,5,'ACT');
...
INSERT INTO `empresa_multinivel` VALUES ('9278986546','Centro Universitario de Alternativas Médicas',1,'0','0','No define','sia.cuam','COL','No define','No define','No define','DES','DES','DES',0,' ',' ',0,0);
...
INSERT INTO `estilo_usuario` VALUES (1,1,'#7dcd9f','#1a1b1a','#069641'),(2,2,'#29ae5f','#000000','#909893'),(29,38,'#7dcd9f','#1a1b1a','#069641');
...
CREATE TABLE `evento` (
  ...
  `observaciones` varchar(150) DEFAULT NULL,
  `estatus` varchar(3) DEFAULT 'ACT',
  `hora0` varchar(10) DEFAULT '00:00:00',
  `hora1` varchar(10) DEFAULT '00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `evento` VALUES (2,'Inducción','Evento de Inducción y Presentación de las Salas, Grupos de Clase, Docentes y Laboratorios de la Institución.','2017-01-22','2017-01-25',1,1,1,1,100,0,0,'Lectura 1','ACT','09:00:00:0','14:00:00:0'),(3,'Clase Inicial','conceptos basicos de la medicina del soglo xxi','2017-01-18','2017-01-20',1,1,1,1,100,0,0,'','ACT','08:00:00:0','13:00:00:0'),(4,'Clase de Investigacion 1','Primera Actividad de Campo','2017-01-18','2017-01-20',1,1,1,3,100,10,0,'','ACT','14:30:00:0','17:30:00:0'),(5,'Taller de Medicina 1','Primer Taller de Medicina Alternativa','2017-01-18','2017-01-21',1,1,1,2,50,200,0,'','ACT','20:30:00:0','21:55:00:0');
...
INSERT INTO `formulario` VALUES (1,'perfil lite','ACT','user_profiles'),(2,'perfil estudiante','ACT','user_profiles'),(3,'perfil principal','ACT','users'),(4,'perfil identidad','ACT','user_profiles'),(5,'perfil organizacion','ACT','organizacion'),(6,'perfil residencial','ACT','cross_dir_user'),(7,'perfil educativo','ACT','user_profiles'),(8,'perfil laboral','ACT','user_profiles'),(9,'perfil referencia','ACT','coaplicante'),(10,'perfil contacto','ACT','cross_tel_user'),(11,'perfil social','ACT','user_profiles'),(12,'perfil docente','ACT','user_profiles'),(13,'perfil curriculo','ACT','user_profiles'),(14,'perfil foto','ACT','cross_img_user');
...
INSERT INTO `galeria` VALUES (1,699),(2,828),(2,829),(2,830),(2,831),(2,832);
...
/*!50001 CREATE TABLE `items` (
  `id` tinyint NOT NULL,
  `sku` tinyint NOT NULL,
  `puntos_comisionables` tinyint NOT NULL,
  `item` tinyint NOT NULL,
  `categoria` tinyint NOT NULL,
  `red` tinyint NOT NULL,
  `id_tipo_mercancia` tinyint NOT NULL
) ENGINE=MyISAM */;
...
INSERT INTO `organizacion` VALUES (1,2,1,'empleado');
...
CREATE TABLE `sede` (
  ...
  `dbhost` varchar(150) DEFAULT NULL,
  `dbuser` varchar(65) DEFAULT NULL,
  `dbkey` varchar(65) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sede` VALUES (1,'SEDE CENTRAL','Sede Central del CUAM','7230','Calle Manzanillo No.90 , Colonia Roma Sur. Del. Cuauhtémoc','5211 - 9525 / 9628 , 3608 - 1039 / 1064.','2017-01-13 16:38:21','ACT','06760','cuam.org','cuamcentral.db.11569157.hostedresource.com','cuamcentral','cenCUAM#2016'),(2,'SEDE COYOACÁN','Sede CUAM Coyoacán','7230','Moras 736 Int. 6 Col. Acadas Del. Benito Juarez.','55241078 - 0445540849130 - 0445544699938','2017-01-17 16:06:48','ACT','03240','coyoacan.cuam.org','coyoacancuam.db.11569157.hostedresource.com','coyoacancuam','coyCUAM2016#');
...
CREATE TABLE `tipo_dato` (
  ...
  `nombre` varchar(65) NOT NULL,
  `estatus` varchar(3) DEFAULT 'ACT',
  `estructura` varchar(150) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_profiles` (
  ...
  `curriculo` text CHARACTER SET utf8,
  ...
  PRIMARY KEY (`id`),
  KEY `FK_U_ID_idx` (`user_id`),
  KEY `FK_SX_ID_idx` (`id_sexo`),
  KEY `FK_EC_ID_idx` (`id_edo_civil`),
  KEY `FK_EP_ID_idx` (`id_estudio`),
  KEY `FK_TP_ID_idx` (`id_tipo_usuario`),
  KEY `FK_TD_ID_idx` (`id_tiempo_dedicado`),
  KEY `FK_ST_ID_idx` (`id_estatus`),
  KEY `FK_IF_ID_idx` (`id_fiscal`),
  CONSTRAINT `FK_EC_ID` FOREIGN KEY (`id_edo_civil`) REFERENCES `cat_edo_civil` (`id_edo_civil`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_EP_ID` FOREIGN KEY (`id_estudio`) REFERENCES `cat_estudios` (`id_estudio`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_IF_ID` FOREIGN KEY (`id_fiscal`) REFERENCES `cat_usuario_fiscal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_ST_ID` FOREIGN KEY (`id_estatus`) REFERENCES `cat_estatus_afiliado` (`id_estatus`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SX_ID` FOREIGN KEY (`id_sexo`) REFERENCES `cat_sexo` (`id_sexo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_TD_ID` FOREIGN KEY (`id_tiempo_dedicado`) REFERENCES `cat_tiempo_dedicado` (`id_tiempo_dedicado`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_TP_ID` FOREIGN KEY (`id_tipo_usuario`) REFERENCES `cat_tipo_usuario` (`id_tipo_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `user_profiles` VALUES (1,1,1,1,1,5,1,1,1,1,'1','1','David','Hidalgo','0000-00-00','2017-01-17 16:01:03','ACT'),(2,2,1,1,2,5,3,1,1,1,'78997978','1','Sede CUAM','Central','1980-01-01','2017-01-17 05:32:37','ACT'),(29,38,1,1,6,1,1,1,1,1,'40693772','Ninguno','davidhidalgo','hidalgo','1999-12-13','2017-01-12 01:16:10','DES');
...
INSERT INTO `users` VALUES (1,'admin','$2a$08$n7GIrO4xJmW30zmr8./Wd.dhT93nUZj5FG1ctu/weBF3qxYnGrj6a','davidhidalgo@cuam.org',1,0,NULL,NULL,NULL,NULL,NULL,'127.0.0.1','2017-01-19 23:50:36','2015-07-11 00:00:00','2017-01-20 04:50:36',NULL),(2,'CUAMCENTRAL','$2a$08$9TuyZxEKeeLKy9E8nhOWWO7o2n8.Cfm/totdLHTqi.mZMLNL6HDzi','cuamcentral@cuam.org',1,0,NULL,NULL,NULL,NULL,NULL,'127.0.0.1','2017-01-17 15:35:49','2015-05-11 00:00:00','2017-01-17 20:35:49','toor'),(38,'davidhidalgo','$2a$08$5aqZFRaizEt0HaA1KbRkvuEoIPNvWE/wGRo22XOCSLuMX6ZcO8CoG','davidhidalgo@gmail.com',1,0,NULL,NULL,NULL,NULL,NULL,'127.0.0.1','0000-00-00 00:00:00','2017-01-11 20:16:10','2017-01-12 01:16:10','toor');
...
INSERT INTO `users_attempts` VALUES ('127.0.0.1','2017-01-16 00:43:42',1,0);
...
-- Dump completed on 2017-01-20  1:15:41
